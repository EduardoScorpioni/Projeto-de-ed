...
<body>
  <?php $paginaAtual = 'inicio'; require APP_PATH . '/Views/partials/header.php'; ?>
  ...
  <main>
    ...
    <section class="intro-band">
      <div class="intro-copy">
        <p class="eyebrow">Trabalho Prático 3 | Ambiente de ensino</p>
        <h1>
          <span id="typed-title"></span><span class="typed-cursor" aria-hidden="true">|</span>
        </h1>
        <p>
          Base do sistema web do Grupo 6 para apresentar conceitos de
          TAD, listas simplesmente encadeadas, listas duplamente encadeadas,
          fila FIFO, pilha, diagramas e exemplos em C#.
        </p>
...
public void InserirInicio(int valor)
{
    ...
    <section class="section alt-section">
      ...
      <div class="module-grid">
        ...
        <a class="module-card" href="pages/fila.php">
          <span>Fila</span>
        ...
        <a class="module-card" href="pages/pilha.php">
          ...
          <p>O último elemento a entrar é o primeiro a sair.</p>
        </a>
      </div>
    </section>
  ...
  <footer class="footer">
    <p>Base web criada para o Trabalho Prático 3 de Estrutura de Dados.</p>
  </footer>
