...
<body>
  <header class="topbar">
    ...
    <nav class="main-nav" aria-label="Navegação principal">
      ...
      <a href="tad.html" aria-current="page">TAD</a>
  ...
  <main>
    <section class="page-hero">
      ...
      <img src="../assets/img/tad.svg" alt="Diagrama de tipo abstrato de dados">
    </section>
